...
df = pd.read_excel("testdata19_1.xlsx")#ต้องเปลี่ยนนะ
...
for i, x in enumerate(df["num"]):
    ...
    try:
        ...
        image = Image.open("original34.jpg") #ต้องเปลี่ยนนะ    
        draw = ImageDraw.Draw(image)


        
        date_email ="24/02/2022" #ต้องเปลี่ยนนะ
        topic= "Risks and Opportunities ISO9001/IAFTF16949" #ต้องเปลี่ยนนะ
        folder = "086" #ต้องเปลี่ยนนะ
        certi = "Q "+str(no)+"/2022"
...
Fax. 02 7537452
Mobile  085 8038380"""
        sender_email = "qaquality456@gmail.com"
        sender_email2 = "qaquality357@gmail.com"
